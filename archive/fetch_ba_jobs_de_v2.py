                    ...
                    with urllib.request.urlopen(req, context=context, timeout=15) as response:
                        if response.status == 200:
                            ...
                            for job in listings:
                                ...
                                # Blockiert gezielt Ausbildungs-Rauschen und reinen IT-Support
                                noise_blacklist = [
                                    "support", "helpdesk", "systemadministrator", "netzwerk", 
                                    "hardware", "first-level", "anwendersupport",
                                    # Ausbildungs- und Handels-Noise:
                            ...
                            # --- HIER WAR DER FEHLER: JETZT KORREKT AUSSERHALB DER FOR-SCHLEIFE ---
...
if __name__ == "__main__":
    print("▶ Starte Ingestion Pipeline v2...")
